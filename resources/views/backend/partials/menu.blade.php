                    ...
                    <li class="sidebar-item has-sub">
                        ...
                        <ul class="submenu">
                            <li class="submenu-item {{ request()->routeIs('pelanggan.index') ? 'active' : '' }}">
                                <a href="{{ route('pelanggan.index') }}" class="submenu-link">Pelanggan</a>
                            </li>
                            <li class="submenu-item {{ request()->routeIs('products.index') ? 'active' : '' }}">
                                <a href="{{ route('products.index') }}" class="submenu-link">Produk</a>
                            </li>
                            <li class="submenu-item {{ request()->routeIs('pesanan.index') ? 'active' : '' }}">
                                <a href="{{ route('pesanan.index') }}" class="submenu-link">Pesanan</a>
                            </li>
                            <li class="submenu-item {{ request()->routeIs('logistik.index') ? 'active' : '' }}">
                                <a href="{{ route('logistik.index') }}" class="submenu-link">Logistik</a>
                            </li>
                        </ul>
                    </li>
